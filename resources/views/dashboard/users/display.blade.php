...
@section('content')
    <div class="content">
        <div class="row" id="addContent" style="margin-bottom: 20px">
            ...
            <div class="col-xs-6">
                <button id="users" class="btn bg-teal-400 btn-block btn-float btn-float-lg" type="button"><i class="icon-list-numbered"></i> <span>المستخدمين : {{App\Models\User::where('is_Provider',0)->count()}} </span> </button>
            </div>
        </div>
